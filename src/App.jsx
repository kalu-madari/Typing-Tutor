                  ...
                  <div key={lesson.id} className={`lesson-item ${isCompleted ? 'completed' : ''}`}>
                    <div className="lesson-icon" style={{ color: isCompleted ? 'var(--success)' : 'inherit' }}>
                      {isCompleted ? (
                        ...
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '22px', height: '22px', borderRadius: '50%', background: 'rgba(255, 255, 255, 0.05)', border: '1px solid var(--border-soft)', fontSize: '11px', fontWeight: 'bold', color: 'var(--text-muted)' }}>{lessonIndex + 1}</span>
                      )}
                    </div>
